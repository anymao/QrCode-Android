...
#define TAG "WeChatScanner-Native"
...
Java_com_anymore_qrcode_wechat_scanner_WeChatScanner_detectAndDecode(JNIEnv *env,
                                                                     jobject thiz,
                                                                     jlong self,
                                                                     jlong img_nativeObj,
...
Java_com_anymore_qrcode_wechat_scanner_WeChatScanner_delete(JNIEnv *env, jobject thiz, jlong self) {
